# Basic Matrix Factorization Algorithm
# Created by August
# 2018/09/28
...
#        2.http://www.sohu.com/a/190681269_470008
...
class MF(object):
    def __init__(self):
        ...
        ratings_file_path = r"C:\Users\August\PycharmProjects\MachineLearningAlgorithm\dataset\doubanTest\ratings.txt"
        self.ratings = self.load_data(ratings_file_path)
        train_file_path = r"C:\Users\August\PycharmProjects\MachineLearningAlgorithm\dataset\doubanTest\train.txt"
        self.train = self.load_data(train_file_path)
        test_file_path = r"C:\Users\August\PycharmProjects\MachineLearningAlgorithm\dataset\doubanTest\test.txt"
    ...
    def run_algorithm(self):
        ...
        while iter_curr < self.iter:
            ...
            for record in self.train:
                ...
                p = self.P[user_id]
                q = self.Q[item_id]
                self.P[user_id] += self.learning_rate * error * q
                self.Q[item_id] += self.learning_rate * error * p
            iter_curr += 1
    ...
    def evaluate(self):
        ...
        out_filename = "MF_Predict_for_Rating" + "@" + current_time + ".txt"
